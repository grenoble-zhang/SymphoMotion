...
def load_video(video_path, max_retries=5):
    import time
    for attempt in range(max_retries):
        try:
            ...
            if attempt < max_retries - 1:
                ...
                print(f"[load_video] NFS read error on {video_path}, "
...
def traj_map(traj_type):
    ...
    if traj_type == "free1":  # Zoom out and rotate to the upper left
    ...
    elif traj_type == "free6":  # Large-angle camera movement to the upper right
        cam_traj = "free"
        x_offset = 0.0
        y_offset = 0.0
        z_offset = 0.0
        ...
        d_phi = 25.0
        d_r = 1.2
    elif traj_type == "free7":  # Large-angle camera movement to the upper right
        cam_traj = "free"
        x_offset = 0.0
        y_offset = 0.0
        z_offset = 0.0
        ...
        d_phi = 0
        d_r = 1.2
    elif traj_type == "free8":  # Large-angle camera movement to the upper right
        cam_traj = "free"
        x_offset = 0.0
        y_offset = 0.0
        z_offset = 0.0
